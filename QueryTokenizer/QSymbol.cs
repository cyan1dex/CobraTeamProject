...
namespace Cobra.QTokenizer
{
   public class QSymbol
   {
      ...
      public const int TOKEN_WILDCARD = 21;
      public const int TOKEN_QUOTE = 99;
      public const int TOKEN_EOF = 999;
   }

   public class Special : QSymbol
   {
      ...
      public const int TOKEN_SPACE = 35;
   }

   public class Reserved : QSymbol
   {
      public const int TOKEN_LEFTCURLY = 66;
      public const int TOKEN_RIGHTCURLY = 67;    
   }

   public class FunctionalSymbol : QSymbol
   {
       public const string FTOKEN_QUOTE = "\"";
       public const string FTOKEN_MINUS = "-";
       public const string FTOKEN_PLUS = "+";
       public const string FTOKEN_OR = "OR";
       public const string FTOKEN_EXACT = "=PQ";
       public const string FTOKEN_SPACE = " ";
       public const string FTOKEN_WILDCARD = "*";
       public const string FTOKEN_WILDCARD_STRING = "WCQ";
   }
}
